...
directory_path = "/Users/felixdiederichs/PycharmProjects/Data_Analysis/.venv/Data/synthetic/heart/heart_1"
...
for loop in sorted(os.listdir(directory_path), key=custom_sort_2):
    ...
    loop_path = f"/Users/felixdiederichs/PycharmProjects/Data_Analysis/.venv/Data/synthetic/heart/heart_1/{loop}"
    ...
    for i in os.listdir(loop_path):
        ...
        all_results.to_csv(f"{report_path}/heart/Fairness/heart_1/{loop}/utility_heart_1_{loop}_trtr.csv", index=False)
        ...
        all_results.to_csv(f"{report_path}/heart/Utility/heart_1/{loop}/heart_1_{loop}_tstr.csv",index=False)
