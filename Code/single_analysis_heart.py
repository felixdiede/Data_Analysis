...
synthetic_data = pd.read_csv("/Users/felixdiederichs/PycharmProjects/Data_Analysis/.venv/Data/synthetic/heart/heart_1/loop_1/heart_ctgan_150.csv")
...
"""cos_distance = execute_cosine_distances(real_data, synthetic_data)
print(f"cos-distance: {cos_distance}")

wass_distance = execute_wass_distances(real_data, synthetic_data)
print(f"wass-distance: {wass_distance}")

js_distance = execute_js_distances(real_data, synthetic_data)
...
dl = execute_data_labelling(real_data, synthetic_data, num_features, cat_features)
print(f"dl: {dl}")
